#ifndef SQRBOXFILTERMODEL_H
#define SQRBOXFILTERMODEL_H
...
class SqrBoxFilterModel final : public QtNodes::NodeDelegateModel {
    Q_OBJECT

public:
    SqrBoxFilterModel();

    ~SqrBoxFilterModel() override;
